    ...
    try {
      ...
      if (e.response) {
        if (e.response.status === 401) {
          this.props.setError('You do not have permission to edit this topic', 3000)
        } else {
...
const ConnectedTopicEditPage = connect(mapStateToProps, mapDispatchToProps)(TopicEditPage)
