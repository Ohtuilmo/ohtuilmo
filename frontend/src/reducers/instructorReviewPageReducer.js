...
const updateRevieweeQuestionAnswer = (user, targetQuestionIndex, answer) => ({
  ...
  answers: user.answers.map((question, questionIndex) =>
    questionIndex === targetQuestionIndex ? updateQuestionAnswer(question, answer) : question,
  ),
})

const updateAnswerSheet = (answerSheet, targetUserIndex, targetQuestionIndex, answer) => {
