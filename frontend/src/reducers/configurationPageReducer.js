    ...
    case 'UPDATE_CONFIG_FORM':
      return {
        ...
        form: {
          ...
          registration_question_set_id: action.payload.registration_question_set
            ? action.payload.registration_question_set.id
            : null,
          review_question_set1_id: action.payload.review_question_set1
            ? action.payload.review_question_set1.id
            : null,
          review_question_set2_id: action.payload.review_question_set2
            ? action.payload.review_question_set2.id
            : null,
