...
module.exports = {
  up: async (query, Sequelize) => {
    await query.addColumn('email_templates', 'customer_review_link_fin', Sequelize.TEXT)
    await query.addColumn('email_templates', 'customer_review_link_eng', Sequelize.TEXT)
