...
module.exports = {
  ...
  down: async (query) => {
    ...
    */
    ...
    await query.removeColumn('configurations', 'customer_review_question_set_id')

    await query.removeConstraint('customer_reviews', 'customer_reviews_configuration_fkey')
    await query.removeConstraint('customer_reviews', 'customer_reviews_group_fkey')
    await query.removeConstraint('customer_reviews', 'customer_reviews_topic_fkey')
