...
module.exports = {
  up: async (query, Sequelize) => {
    ...
    await query.addColumn('registration_managements', 'peer_review_conf', Sequelize.INTEGER)

    await query.addColumn('registration_managements', 'topic_registration_conf', Sequelize.INTEGER)
  ...
  down: async (query, Sequelize) => {
    ...
    await query.removeColumn('registration_managements', 'project_registration_conf')

    await query.removeColumn('registration_managements', 'peer_review_conf')

    await query.removeColumn('registration_managements', 'topic_registration_conf')
